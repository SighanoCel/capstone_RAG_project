...
Conversational RAG (with memory) over the Capstone Final Report, mirroring
notebooks/Capstone_project_LCEL_Memory.ipynb. Reuses the same ingestion module
(pdf_ingestion.py) and chain (rag.build_conversational_rag) as app.py.
...
# ---------------------------------------------------------------------------
# Build the conversational RAG chain once and cache it (survives reruns)
# ---------------------------------------------------------------------------
